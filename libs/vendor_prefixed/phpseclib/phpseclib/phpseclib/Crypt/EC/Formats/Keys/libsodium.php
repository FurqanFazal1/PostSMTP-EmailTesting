...
abstract class libsodium
{
     ...
     * @return string
     */
    public static function savePublicKey(\PostSMTPMailTester\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey)
    {
     ...
     * @return string
     */
    public static function savePrivateKey(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $privateKey, \PostSMTPMailTester\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519 $curve, array $publicKey, $secret = null, $password = '')
    {
        if (!isset($secret)) {
        ...
        if (!empty($password) && \is_string($password)) {
            throw new \PostSMTPMailTester\Vendor\phpseclib3\Exception\UnsupportedFormatException('libsodium private keys do not support encryption');
        }
