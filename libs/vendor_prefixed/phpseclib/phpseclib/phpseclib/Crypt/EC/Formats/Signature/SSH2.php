...
abstract class SSH2
{
    ...
    public static function load($sig)
    {
        ...
        $result = \PostSMTPMailTester\Vendor\phpseclib3\Common\Functions\Strings::unpackSSH2('ii', $blob);
        if ($result === \false) {
            return \false;
        }
     ...
     * @return string
     */
    public static function save(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $r, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $s, $curve)
    {
        switch ($curve) {
            case 'secp256r1':
                $curve = 'nistp256';
        ...
        $blob = \PostSMTPMailTester\Vendor\phpseclib3\Common\Functions\Strings::packSSH2('ii', $r, $s);
        return \PostSMTPMailTester\Vendor\phpseclib3\Common\Functions\Strings::packSSH2('ss', 'ecdsa-sha2-' . $curve, $blob);
    }
}
