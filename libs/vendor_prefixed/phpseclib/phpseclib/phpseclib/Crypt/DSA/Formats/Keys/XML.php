...
abstract class XML
{
    ...
    {
        return "<DSAKeyValue>\r\n" . '  <P>' . \PostSMTPMailTester\Vendor\phpseclib3\Common\Functions\Strings::base64_encode($p->toBytes()) . "</P>\r\n" . '  <Q>' . \PostSMTPMailTester\Vendor\phpseclib3\Common\Functions\Strings::base64_encode($q->toBytes()) . "</Q>\r\n" . '  <G>' . \PostSMTPMailTester\Vendor\phpseclib3\Common\Functions\Strings::base64_encode($g->toBytes()) . "</G>\r\n" . '  <Y>' . \PostSMTPMailTester\Vendor\phpseclib3\Common\Functions\Strings::base64_encode($y->toBytes()) . "</Y>\r\n" . '</DSAKeyValue>';
    }
}
