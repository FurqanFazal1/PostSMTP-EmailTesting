...
abstract class ASN1
{
    ...
    public static function load($sig)
    {
        ...
        $components = \PostSMTPMailTester\Vendor\phpseclib3\File\ASN1::asn1map($decoded[0], \PostSMTPMailTester\Vendor\phpseclib3\File\ASN1\Maps\DssSigValue::MAP);
        return $components;
    }
    /**
    ...
    {
        return \PostSMTPMailTester\Vendor\phpseclib3\File\ASN1::encodeDER(\compact('r', 's'), \PostSMTPMailTester\Vendor\phpseclib3\File\ASN1\Maps\DssSigValue::MAP);
    }
}
