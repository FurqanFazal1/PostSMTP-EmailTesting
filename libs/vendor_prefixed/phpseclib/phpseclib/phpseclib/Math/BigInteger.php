 ...
 */
namespace PostSMTPMailTester\Vendor\phpseclib3\Math;

use PostSMTPMailTester\Vendor\phpseclib3\Exception\BadConfigurationException;
use PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
/**
...
class BigInteger implements \JsonSerializable
{
    ...
    {
        self::$engines = [];
        $fqmain = 'PostSMTPMailTester\\Vendor\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
        ...
        if (!$fqmain::isValidEngine()) {
            throw new \PostSMTPMailTester\Vendor\phpseclib3\Exception\BadConfigurationException("{$main} is not setup correctly on this system");
        }
        ...
        if (!$found) {
            throw new \PostSMTPMailTester\Vendor\phpseclib3\Exception\BadConfigurationException("No valid modular exponentiation engine found for {$main}");
        }
    ...
    public function __construct($x = 0, $base = 10)
    {
        ...
        if ($x instanceof self::$mainEngine) {
            $this->value = clone $x;
        } elseif ($x instanceof \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\Engine) {
     ...
     * @return BigInteger
     */
    public function add(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function subtract(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function multiply(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger[]
     */
    public function divide(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return BigInteger
     */
    public function modInverse(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger[]
     */
    public function extendedGCD(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function gcd(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function powMod(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $e, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public function modPow(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $e, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @see self::equals()
     */
    public function compare(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $y)
    {
     ...
     * @return bool
     */
    public function equals(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_and(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_or(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     * @return BigInteger
     */
    public function bitwise_xor(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $x)
    {
     ...
     */
    public static function randomRangePrime(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $min, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function randomRange(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $min, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $max)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public function pow(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $n)
    {
     ...
     * @return BigInteger
     */
    public static function min(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
     ...
     * @return BigInteger
     */
    public static function max(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger ...$nums)
    {
        $class = self::$mainEngine;
        $nums = \array_map(function ($num) {
            return $num->value;
     ...
     * @return bool
     */
    public function between(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $min, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $r)
    {
        $class = self::$mainEngine;
    ...
    public function createRecurringModuloFunction()
    {
        ...
        return function (\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger $x) use($func) {
