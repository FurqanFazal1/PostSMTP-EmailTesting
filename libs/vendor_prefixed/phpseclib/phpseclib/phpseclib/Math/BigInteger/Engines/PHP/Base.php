 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class Base extends \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP
{
    /**
     * Cache constants
     *
     ...
     * @return PHP
     */
    protected static function powModHelper(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $x, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $e, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = [1];
