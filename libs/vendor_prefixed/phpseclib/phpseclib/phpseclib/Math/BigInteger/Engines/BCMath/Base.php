 ...
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class Base extends \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath
{
    /**
     * Cache constants
     *
     ...
     * @return BCMath
     */
    protected static function powModHelper(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $x, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $e, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $n, $class)
    {
        if (empty($e->value)) {
            $temp = new $class();
            $temp->value = '1';
