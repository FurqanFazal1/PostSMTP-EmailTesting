...
use PostSMTPMailTester\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8;
...
abstract class OpenSSL
{
     ...
     * @return Engine
     */
    public static function powModHelper(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $x, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $e, \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $n)
    {
        ...
        $key = \PostSMTPMailTester\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8::savePublicKey(new \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger($n), new \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger($e));
