 ...
 */
namespace PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;
use PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Dynamic Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
abstract class EvalBarrett extends \PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Base
{
    /**
     ...
     * @return callable
     */
    protected static function generateCustomReduction(\PostSMTPMailTester\Vendor\phpseclib3\Math\BigInteger\Engines\PHP $m, $class)
    {
