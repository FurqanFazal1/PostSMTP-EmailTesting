...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \PostSMTPMailTester\Vendor\Psr\Log\LogLevel::CRITICAL, $callPrevious = \true, $restartSyscalls = \true, $async = \true)
    {
    ...
    public function handleSignal($signo, array $siginfo = null)
    {
        ...
        $level = isset($this->signalLevelMap[$signo]) ? $this->signalLevelMap[$signo] : \PostSMTPMailTester\Vendor\Psr\Log\LogLevel::CRITICAL;
