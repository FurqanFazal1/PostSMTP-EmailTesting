...
use PostSMTPMailTester\Vendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \PostSMTPMailTester\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \PostSMTPMailTester\Vendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
