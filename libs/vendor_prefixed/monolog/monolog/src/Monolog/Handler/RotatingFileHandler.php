 ...
 */
class RotatingFileHandler extends \PostSMTPMailTester\Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \PostSMTPMailTester\Vendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \PostSMTPMailTester\Vendor\Monolog\Utils::canonicalizePath($filename);
