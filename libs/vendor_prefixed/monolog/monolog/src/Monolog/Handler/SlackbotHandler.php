 ...
 */
class SlackbotHandler extends \PostSMTPMailTester\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \PostSMTPMailTester\Vendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
