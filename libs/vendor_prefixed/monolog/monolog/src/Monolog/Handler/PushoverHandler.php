 ...
 */
class PushoverHandler extends \PostSMTPMailTester\Vendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \PostSMTPMailTester\Vendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \PostSMTPMailTester\Vendor\Monolog\Logger::CRITICAL, $emergencyLevel = \PostSMTPMailTester\Vendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \PostSMTPMailTester\Vendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \PostSMTPMailTester\Vendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
