 ...
 * @final
 */
class LimitStream implements \PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
