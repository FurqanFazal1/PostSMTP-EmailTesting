...
class StreamWrapper
{
     ...
     */
    public static function getResource(\PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
