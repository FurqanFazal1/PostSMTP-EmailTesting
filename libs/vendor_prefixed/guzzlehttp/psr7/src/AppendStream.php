 ...
 * @final
 */
class AppendStream implements \PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \PostSMTPMailTester\Vendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
