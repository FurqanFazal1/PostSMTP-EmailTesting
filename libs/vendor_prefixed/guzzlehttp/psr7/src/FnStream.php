 ...
 * @final
 */
class FnStream implements \PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\PostSMTPMailTester\Vendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
