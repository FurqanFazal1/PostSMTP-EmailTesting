...
final class EasyHandle
{
    ...
    public function createResponse()
    {
        ...
        $headers = \PostSMTPMailTester\Vendor\GuzzleHttp\headers_from_lines($this->headers);
        ...
        $this->response = new \PostSMTPMailTester\Vendor\GuzzleHttp\Psr7\Response($startLine[1], $headers, $this->sink, \substr($startLine[0], 5), isset($startLine[2]) ? (string) $startLine[2] : null);
    }
