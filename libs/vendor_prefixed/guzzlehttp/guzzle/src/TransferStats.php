...
final class TransferStats
{
     ...
     */
    public function __construct(\PostSMTPMailTester\Vendor\Psr\Http\Message\RequestInterface $request, \PostSMTPMailTester\Vendor\Psr\Http\Message\ResponseInterface $response = null, $transferTime = null, $handlerErrorData = null, $handlerStats = [])
    {
