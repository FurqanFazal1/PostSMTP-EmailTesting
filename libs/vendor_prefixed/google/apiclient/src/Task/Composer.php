...
use PostSMTPMailTester\Vendor\Composer\Script\Event;
use PostSMTPMailTester\Vendor\Symfony\Component\Filesystem\Filesystem;
use PostSMTPMailTester\Vendor\Symfony\Component\Finder\Finder;
...
class Composer
{
     ...
     */
    public static function cleanup(\PostSMTPMailTester\Vendor\Composer\Script\Event $event, \PostSMTPMailTester\Vendor\Symfony\Component\Filesystem\Filesystem $filesystem = null)
    {
        ...
        if ($servicesToKeep) {
            ...
            $filesystem = $filesystem ?: new \PostSMTPMailTester\Vendor\Symfony\Component\Filesystem\Filesystem();
    ...
    {
        $finder = (new \PostSMTPMailTester\Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0');
    ...
    private static function getServicesToRemove($serviceDir, array $servicesToKeep)
    {
        ...
        return (new \PostSMTPMailTester\Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0')->in($serviceDir)->exclude($servicesToKeep);
    }
}
