...
class Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \PostSMTPMailTester\Vendor\Google\Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \PostSMTPMailTester\Vendor\Google\Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
