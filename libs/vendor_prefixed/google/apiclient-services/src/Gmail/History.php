...
class History extends \PostSMTPMailTester\Vendor\Google\Collection
{
     ...
     */
    public $id;
    protected $labelsAddedType = \PostSMTPMailTester\Vendor\Google\Service\Gmail\HistoryLabelAdded::class;
    protected $labelsAddedDataType = 'array';
    protected $labelsRemovedType = \PostSMTPMailTester\Vendor\Google\Service\Gmail\HistoryLabelRemoved::class;
    protected $labelsRemovedDataType = 'array';
    protected $messagesType = \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class;
    protected $messagesDataType = 'array';
    protected $messagesAddedType = \PostSMTPMailTester\Vendor\Google\Service\Gmail\HistoryMessageAdded::class;
    protected $messagesAddedDataType = 'array';
    protected $messagesDeletedType = \PostSMTPMailTester\Vendor\Google\Service\Gmail\HistoryMessageDeleted::class;
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\History::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_History');
