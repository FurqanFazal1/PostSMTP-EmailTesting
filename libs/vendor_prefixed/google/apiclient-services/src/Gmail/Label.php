...
class Label extends \PostSMTPMailTester\Vendor\Google\Model
{
    protected $colorType = \PostSMTPMailTester\Vendor\Google\Service\Gmail\LabelColor::class;
     ...
     * @param LabelColor
     */
    public function setColor(\PostSMTPMailTester\Vendor\Google\Service\Gmail\LabelColor $color)
    {
        $this->color = $color;
    }
    /**
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Label::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Label');
