...
class WatchRequest extends \PostSMTPMailTester\Vendor\Google\Collection
{
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\WatchRequest::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_WatchRequest');
