...
class ForwardingAddress extends \PostSMTPMailTester\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\ForwardingAddress::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_ForwardingAddress');
