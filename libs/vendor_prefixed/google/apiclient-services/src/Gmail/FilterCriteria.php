...
class FilterCriteria extends \PostSMTPMailTester\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\FilterCriteria::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_FilterCriteria');
