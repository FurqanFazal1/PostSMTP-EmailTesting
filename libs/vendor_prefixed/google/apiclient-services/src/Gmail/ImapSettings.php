...
class ImapSettings extends \PostSMTPMailTester\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\ImapSettings::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_ImapSettings');
