...
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ForwardingAddress;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ListForwardingAddressesResponse;
/**
 ...
 *  </code>
 */
class UsersSettingsForwardingAddresses extends \PostSMTPMailTester\Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function create($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\ForwardingAddress $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ForwardingAddress::class);
    }
    /**
    ...
    public function get($userId, $forwardingEmail, $optParams = [])
    {
        $params = ['userId' => $userId, 'forwardingEmail' => $forwardingEmail];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ForwardingAddress::class);
    }
    /**
    ...
    public function listUsersSettingsForwardingAddresses($userId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ListForwardingAddressesResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Resource\UsersSettingsForwardingAddresses::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Resource_UsersSettingsForwardingAddresses');
