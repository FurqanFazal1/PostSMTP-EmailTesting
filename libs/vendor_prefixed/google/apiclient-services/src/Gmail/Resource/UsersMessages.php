...
use PostSMTPMailTester\Vendor\Google\Service\Gmail\BatchDeleteMessagesRequest;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\BatchModifyMessagesRequest;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ListMessagesResponse;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\Message;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ModifyMessageRequest;
/**
 ...
 *  </code>
 */
class UsersMessages extends \PostSMTPMailTester\Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function batchDelete($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\BatchDeleteMessagesRequest $postBody, $optParams = [])
    {
     ...
     * @param array $optParams Optional parameters.
     */
    public function batchModify($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\BatchModifyMessagesRequest $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
    ...
    public function get($userId, $id, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class);
    }
    /**
     ...
     * @return Message
     */
    public function import($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('import', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class);
    }
    /**
     ...
     * @return Message
     */
    public function insert($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class);
    }
    /**
    ...
    public function listUsersMessages($userId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ListMessagesResponse::class);
    }
    /**
     ...
     * @return Message
     */
    public function modify($userId, $id, \PostSMTPMailTester\Vendor\Google\Service\Gmail\ModifyMessageRequest $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('modify', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class);
    }
    /**
     ...
     * @return Message
     */
    public function send($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('send', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class);
    }
    /**
    ...
    public function trash($userId, $id, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('trash', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class);
    }
    /**
    ...
    public function untrash($userId, $id, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('untrash', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Message::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Resource\UsersMessages::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Resource_UsersMessages');
