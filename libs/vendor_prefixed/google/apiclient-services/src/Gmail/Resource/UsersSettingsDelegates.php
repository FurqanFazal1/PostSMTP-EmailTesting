...
use PostSMTPMailTester\Vendor\Google\Service\Gmail\Delegate;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ListDelegatesResponse;
/**
 ...
 *  </code>
 */
class UsersSettingsDelegates extends \PostSMTPMailTester\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return Delegate
     */
    public function create($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\Delegate $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Delegate::class);
    }
    /**
    ...
    public function get($userId, $delegateEmail, $optParams = [])
    {
        $params = ['userId' => $userId, 'delegateEmail' => $delegateEmail];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Delegate::class);
    }
    /**
    ...
    public function listUsersSettingsDelegates($userId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ListDelegatesResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Resource\UsersSettingsDelegates::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Resource_UsersSettingsDelegates');
