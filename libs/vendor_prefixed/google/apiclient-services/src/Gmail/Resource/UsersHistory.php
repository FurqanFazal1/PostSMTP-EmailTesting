...
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ListHistoryResponse;
/**
 ...
 *  </code>
 */
class UsersHistory extends \PostSMTPMailTester\Vendor\Google\Service\Resource
{
    /**
    ...
    public function listUsersHistory($userId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ListHistoryResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Resource\UsersHistory::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Resource_UsersHistory');
