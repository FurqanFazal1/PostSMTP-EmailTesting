...
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ListSendAsResponse;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs;
/**
 ...
 *  </code>
 */
class UsersSettingsSendAs extends \PostSMTPMailTester\Vendor\Google\Service\Resource
{
    /**
     ...
     * @return SendAs
     */
    public function create($userId, \PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs::class);
    }
    /**
    ...
    public function get($userId, $sendAsEmail, $optParams = [])
    {
        $params = ['userId' => $userId, 'sendAsEmail' => $sendAsEmail];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs::class);
    }
    /**
    ...
    public function listUsersSettingsSendAs($userId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ListSendAsResponse::class);
    }
    /**
     ...
     * @return SendAs
     */
    public function patch($userId, $sendAsEmail, \PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'sendAsEmail' => $sendAsEmail, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs::class);
    }
    /**
     ...
     * @return SendAs
     */
    public function update($userId, $sendAsEmail, \PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'sendAsEmail' => $sendAsEmail, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs::class);
    }
    /**
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Resource\UsersSettingsSendAs::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Resource_UsersSettingsSendAs');
