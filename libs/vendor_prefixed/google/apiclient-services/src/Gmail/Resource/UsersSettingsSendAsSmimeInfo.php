...
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ListSmimeInfoResponse;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\SmimeInfo;
/**
 ...
 *  </code>
 */
class UsersSettingsSendAsSmimeInfo extends \PostSMTPMailTester\Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($userId, $sendAsEmail, $id, $optParams = [])
    {
        $params = ['userId' => $userId, 'sendAsEmail' => $sendAsEmail, 'id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\SmimeInfo::class);
    }
    /**
     ...
     * @return SmimeInfo
     */
    public function insert($userId, $sendAsEmail, \PostSMTPMailTester\Vendor\Google\Service\Gmail\SmimeInfo $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'sendAsEmail' => $sendAsEmail, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\SmimeInfo::class);
    }
    /**
    ...
    public function listUsersSettingsSendAsSmimeInfo($userId, $sendAsEmail, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ListSmimeInfoResponse::class);
    }
    /**
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Resource\UsersSettingsSendAsSmimeInfo::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Resource_UsersSettingsSendAsSmimeInfo');
