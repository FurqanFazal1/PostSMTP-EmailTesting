...
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ListThreadsResponse;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\ModifyThreadRequest;
use PostSMTPMailTester\Vendor\Google\Service\Gmail\Thread;
/**
 ...
 *  </code>
 */
class UsersThreads extends \PostSMTPMailTester\Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($userId, $id, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Thread::class);
    }
    /**
    ...
    public function listUsersThreads($userId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\ListThreadsResponse::class);
    }
    /**
     ...
     * @return Thread
     */
    public function modify($userId, $id, \PostSMTPMailTester\Vendor\Google\Service\Gmail\ModifyThreadRequest $postBody, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('modify', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Thread::class);
    }
    /**
    ...
    public function trash($userId, $id, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('trash', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Thread::class);
    }
    /**
    ...
    public function untrash($userId, $id, $optParams = [])
    {
        $params = ['userId' => $userId, 'id' => $id];
        $params = \array_merge($params, $optParams);
        return $this->call('untrash', [$params], \PostSMTPMailTester\Vendor\Google\Service\Gmail\Thread::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Resource\UsersThreads::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Resource_UsersThreads');
