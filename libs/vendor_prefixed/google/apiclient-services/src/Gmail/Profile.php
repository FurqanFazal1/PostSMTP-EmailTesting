...
class Profile extends \PostSMTPMailTester\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\Profile::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_Profile');
