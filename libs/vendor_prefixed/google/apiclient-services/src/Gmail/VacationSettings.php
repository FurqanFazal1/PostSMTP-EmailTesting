...
class VacationSettings extends \PostSMTPMailTester\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\VacationSettings::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_VacationSettings');
