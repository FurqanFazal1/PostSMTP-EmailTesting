...
class SmimeInfo extends \PostSMTPMailTester\Vendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\SmimeInfo::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_SmimeInfo');
