...
class SendAs extends \PostSMTPMailTester\Vendor\Google\Model
{
    /**
     * @var string
     */
     ...
     */
    public $signature;
    protected $smtpMsaType = \PostSMTPMailTester\Vendor\Google\Service\Gmail\SmtpMsa::class;
     ...
     * @param SmtpMsa
     */
    public function setSmtpMsa(\PostSMTPMailTester\Vendor\Google\Service\Gmail\SmtpMsa $smtpMsa)
    {
...
\class_alias(\PostSMTPMailTester\Vendor\Google\Service\Gmail\SendAs::class, 'PostSMTPMailTester\\Vendor\\Google_Service_Gmail_SendAs');
