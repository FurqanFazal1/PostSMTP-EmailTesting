 ...
 */
namespace PostSMTPMailTester\Vendor\Google\Auth\Credentials;

use PostSMTPMailTester\Vendor\Google\Auth\CredentialsLoader;
use PostSMTPMailTester\Vendor\Google\Auth\GetQuotaProjectInterface;
...
use PostSMTPMailTester\Vendor\Google\Auth\Iam;
use PostSMTPMailTester\Vendor\Google\Auth\ProjectIdProviderInterface;
use PostSMTPMailTester\Vendor\Google\Auth\SignBlobInterface;
use PostSMTPMailTester\Vendor\GuzzleHttp\Exception\ClientException;
...
use PostSMTPMailTester\Vendor\GuzzleHttp\Exception\ServerException;
 ...
 */
class GCECredentials extends \PostSMTPMailTester\Vendor\Google\Auth\CredentialsLoader implements \PostSMTPMailTester\Vendor\Google\Auth\SignBlobInterface, \PostSMTPMailTester\Vendor\Google\Auth\ProjectIdProviderInterface, \PostSMTPMailTester\Vendor\Google\Auth\GetQuotaProjectInterface
{
    // phpcs:disable
     ...
     */
    public function __construct(\PostSMTPMailTester\Vendor\Google\Auth\Iam $iam = null, $scope = null, $targetAudience = null, $quotaProject = null, $serviceAccountIdentity = null)
    {
        $this->iam = $iam;
    ...
    {
        $httpHandler = $httpHandler ?: \PostSMTPMailTester\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory::build(\PostSMTPMailTester\Vendor\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        for ($i = 1; $i <= self::MAX_COMPUTE_PING_TRIES; $i++) {
            try {
                ...
                // the metadata resolution was particularly slow. The latter case is
                // "unlikely".
                $resp = $httpHandler(new \PostSMTPMailTester\Vendor\GuzzleHttp\Psr7\Request('GET', $checkUri, [self::FLAVOR_HEADER => 'Google']), ['timeout' => self::COMPUTE_PING_CONNECTION_TIMEOUT_S]);
                return $resp->getHeaderLine(self::FLAVOR_HEADER) == 'Google';
            } catch (\PostSMTPMailTester\Vendor\GuzzleHttp\Exception\ClientException $e) {
            } catch (\PostSMTPMailTester\Vendor\GuzzleHttp\Exception\ServerException $e) {
            } catch (\PostSMTPMailTester\Vendor\GuzzleHttp\Exception\RequestException $e) {
            } catch (\PostSMTPMailTester\Vendor\GuzzleHttp\Exception\ConnectException $e) {
            }
        }
        return \false;
    }
    ...
    {
        $httpHandler = \PostSMTPMailTester\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory::build(\PostSMTPMailTester\Vendor\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        $signer = $this->iam ?: new \PostSMTPMailTester\Vendor\Google\Auth\Iam($httpHandler);
    ...
    {
        $resp = $httpHandler(new \PostSMTPMailTester\Vendor\GuzzleHttp\Psr7\Request('GET', $uri, [self::FLAVOR_HEADER => 'Google']));
