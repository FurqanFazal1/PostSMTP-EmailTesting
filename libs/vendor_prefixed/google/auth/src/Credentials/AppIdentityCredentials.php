 ...
 */
use PostSMTPMailTester\Vendor\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \PostSMTPMailTester\Vendor\Google\Auth\CredentialsLoader implements \PostSMTPMailTester\Vendor\Google\Auth\SignBlobInterface, \PostSMTPMailTester\Vendor\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        $token = \PostSMTPMailTester\Vendor\google\appengine\api\app_identity\AppIdentityService::getAccessToken($scope);
    ...
    {
        $this->checkAppEngineContext();
        return \base64_encode(\PostSMTPMailTester\Vendor\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(callable $httpHander = null)
    {
        ...
        return \PostSMTPMailTester\Vendor\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(callable $httpHandler = null)
    {
        $this->checkAppEngineContext();
        if (!$this->clientName) {
            $this->clientName = \PostSMTPMailTester\Vendor\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !\class_exists('PostSMTPMailTester\\Vendor\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
