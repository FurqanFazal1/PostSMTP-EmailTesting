...
use PostSMTPMailTester\Vendor\Google\Auth\CacheTrait;
...
class ScopedAccessTokenMiddleware
{
     ...
     */
    public function __construct(callable $tokenFunc, $scopes, array $cacheConfig = null, \PostSMTPMailTester\Vendor\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
