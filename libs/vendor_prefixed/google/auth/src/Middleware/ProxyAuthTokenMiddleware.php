 ...
 */
namespace PostSMTPMailTester\Vendor\Google\Auth\Middleware;

use PostSMTPMailTester\Vendor\Google\Auth\FetchAuthTokenInterface;
...
class ProxyAuthTokenMiddleware
{
     ...
     */
    public function __construct(\PostSMTPMailTester\Vendor\Google\Auth\FetchAuthTokenInterface $fetcher, callable $httpHandler = null, callable $tokenCallback = null)
    {
    ...
    {
        return function (\PostSMTPMailTester\Vendor\Psr\Http\Message\RequestInterface $request, array $options) use($handler) {
            ...
            if ($quotaProject = $this->getQuotaProject()) {
                $request = $request->withHeader(\PostSMTPMailTester\Vendor\Google\Auth\GetQuotaProjectInterface::X_GOOG_USER_PROJECT_HEADER, $quotaProject);
            }
            return $handler($request, $options);
        };
    }
