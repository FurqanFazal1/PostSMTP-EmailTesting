...
class Iam
{
    ...
    public function signBlob($email, $accessToken, $stringToSign, array $delegates = [])
    {
        ...
        $request = new \PostSMTPMailTester\Vendor\GuzzleHttp\Psr7\Request('POST', $uri, $headers, \PostSMTPMailTester\Vendor\GuzzleHttp\Psr7\Utils::streamFor(\json_encode($body)));
